...
angular.module('cfp.loadingBar', [])
  .provider('cfpLoadingBar', function() {
    ...
    this.startSize = 0.02;
    this.parentSelector = '.container-input';
    this.spinnerTemplate = '<h5 class="tt-secondary inlineh" style="display:inline-block">Searching </h5><div style="display:inline-block"><div id="loading-bar-spinner"><div class="spinner-icon"></div></div></div>';
